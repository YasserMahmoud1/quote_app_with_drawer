...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final XandroidxLibraryAccessors laccForXandroidxLibraryAccessors = new XandroidxLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>xandroidx</b>
     */
    public XandroidxLibraryAccessors getXandroidx() {
        return laccForXandroidxLibraryAccessors;
    }
    ...
    public static class XandroidxLibraryAccessors extends SubDependencyFactory {

        public XandroidxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getAppcompat() {
            return create("xandroidx.appcompat");
        }
